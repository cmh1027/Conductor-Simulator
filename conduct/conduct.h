...
extern const QMap<Difficulty, int> SpeedRollbackCount;
extern const QMap<Dynamic, int> MinimumVerticalDistance;
extern const QMap<Dynamic, int> MaximumVerticalDistance;
extern const QMap<Dynamic, int> MinimumHorizontalDistance;
extern const QMap<Dynamic, int> MaximumHorizontalDistance;
